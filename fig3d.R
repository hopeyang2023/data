...
colnames(data1)[1:7]<-c("N levels","Inorganic N","Soil pH","KO richness","OTU richness",
                        "HGT richness","Virus diversity")
data1
...
colnames(data2)[1:7]<-c("N levels","Inorganic N","Soil pH","KO richness","OTU richness",
                        "HGT richness","Virus diversity")
data2
# plot gridline
