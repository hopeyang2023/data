...
```{r,message=FALSE,warning=FALSE,fig.height=9.8,fig.width=19}
setwd("/Users/yangjianxia/Documents/code_data/Fig.4/e")
library(vegan)
library(ggplot2)
library(colorRamps)
library(ape)
...
p1
ggsave("fig4e_network_degree.pdf",width = 19,height = 9.8)
```
