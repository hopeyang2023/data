...
library(nlme)
rm(list=ls())
setwd("/Users/yangjianxia/Documents/code_data/Fig.1")
...
l<-ggplot(data,aes(x=LN,y=LIN,colour=Nadd))+
  ...
  ylab(bquote(Log[10]~(IN)~(mg~kg^-1)))+theme_bw()+
  ylim(0,8)+
...
p1
ggsave("2017_2019_Nlevel_LIN.pdf",width = 8.46,height = 3.68)
...
p2
ggsave("2017_2019_Nlevel_PH.pdf",width = 8.46,height = 3.68)
...
p3
ggsave("2017_2019_Mn.pdf",width = 8.46,height = 3.68)
...
p4
ggsave("2017_2019_Cu.pdf",width = 8.46,height = 3.68)
